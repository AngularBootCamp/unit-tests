# Angular Boot Camp example: unit-tests
...
**[StackBlitz for unit-tests](https://stackblitz.io/github/AngularBootCamp/unit-tests)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/unit-tests.git
cd unit-tests
npm install
npm start
```
